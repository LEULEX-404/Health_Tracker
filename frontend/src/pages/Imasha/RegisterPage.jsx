            ...
            >
                ...
                <div className="Imasha-form-header">
                    ...
                    <p className="Imasha-form-subtitle">
                        {step === 1 ? 'Join PulseNova and start your wellness journey' : 'Tell us more about your health preferences'}
                    </p>
                </div>
                ...
                <AnimatePresence mode="wait">
                    ...
                    {step === 1 && (
                        ...
                        >
                            ...
                            <PasswordInput
                                ...
                                onChange={handleChange} placeholder="Min 6 chars, 1 upper, 1 number"
                    ...
                    {step === 2 && (
                        <motion.form 
                            ...
                            exit={{ opacity: 0, x: -20 }}
                            transition={{ duration: 0.4 }}
                            onSubmit={handleSubmit} noValidate className="Imasha-field-group"
                        >
                            <div className="Imasha-field-row">
                                <AuthFormInput
                            ...
                            <div className="Imasha-field">
                                ...
                                <div className="Imasha-selection-group">
                                    {GENDERS.map((g) => (
                                        ...
                                        >
                                            {form.gender === g.value && <Check size={16} />}
                                            {g.label}
                                        </button>
                                    ))}
                                </div>
                            ...
                            <AuthFormInput
                                ...
                                onChange={handleChange} placeholder="Your residential address"
                                icon={<MapPin size={18} />}
                            />

                            {/* Health chips */}
                            <div className="Imasha-field">
                                <span className="Imasha-label">Health Conditions <span style={{ fontWeight: 400, textTransform: 'none', opacity: 0.7 }}>(select all that apply)</span></span>
                            ...
                            <div className="Imasha-register-nav" style={{ marginTop: '0.75rem' }}>
